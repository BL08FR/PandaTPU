...
// As it's originally made for Teensy 4.1, some code is useless but it work like this^^.
//
// connection plan:
...
void setup()
{
  ...
  delay(10);
	...
	//Serial.println("\r\nStarting AutoSteer...");// autosteer disabled because it stop communication  with HC05 on Serial4, if you need enable, try change the Serial4 to 5 or to find what interfere with Serial4 in autosteerSetup() funbction (autosteer tab)
	//autosteerSetup();
